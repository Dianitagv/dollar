window.onload = function(){
    ...
    function eliminarProducto(id) {
        ...
        xhr.open("DELETE","http://5d4b6ab500dbb10014879b06.mockapi.io/productos/"+id);
        xhr.send(null);
    }
    function imprimirDetalle(id){
        ...
        xhr.open("GET","http://5d4b6ab500dbb10014879b06.mockapi.io/productos/"+id);
        xhr.send(null);
    }
    ...
    function obtenerProductos(){
        ...
        xhr.open("GET","http://5d4b6ab500dbb10014879b06.mockapi.io/productos");
        xhr.send(null);
